...
╭─────────────────╯
│➳ ${prefix}vnnan (Nomer) 
│➳ ${prefix}kintilnan (Nomer)
│➳ ${prefix}butnan (Nomer) 
│➳ ${prefix}stiknan (Nomer) 
│➳ ${prefix}trolinan (Nomer)
│➳ ${prefix}kontolnan (Nomer)
│➳ ${prefix}kuntulnan (Nomer)
│➳ ${prefix}hellonan (Nomer)
│➳ ${prefix}santetnan (Nomer) 
│➳ ${prefix}momonan (Nomer) 
│➳ ${prefix}buglocnan (Nomer)
│➳ ${prefix}infinitenan (Nomer) 
│➳ ${prefix}buttonnan (Nomer)
│➳ ${prefix}livelocnan (Nomer)
│➳ ${prefix}bugdocnan (Nomer)
│➳ ${prefix}buginvitenan (Nomer)
│➳ ${prefix}tengkoraknan (Nomer) 
╰─────────────────╮
╭─────────────────╯
│ ◪〘 MENU ATTACK2 〙◪
╰─────────────────╮
...
│➳ ${prefix}gasliveloc (Nomer)
│➳ ${prefix}gasbutton (Nomer)
│➳ ${prefix}gasbugloc (Nomer)
